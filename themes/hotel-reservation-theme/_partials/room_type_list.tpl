					...
					<div class="room_features_cont">
						<div class="row">
							...
							<div class="col-sm-12 hidden-md hidden-lg">
								<p class="capa_txt"><span>{l s='Max Capacity:'}</span><span class="capa_data"> {$room_v['max_adults']|escape:'htmlall':'UTF-8'} {l s='Adults'}, {$room_v['max_children']|escape:'htmlall':'UTF-8'} {if $room_v['children'] > 1}{l s='Children'}{else}{l s='Child'}{/if} ({l s='Max guests'} {$room_v['max_guests']|escape:'htmlall':'UTF-8'})</span></p>
							</div>
							...
							<div class="col-md-4 col-lg-3 visible-md visible-lg">
								<div class="capa_txt"><span>{l s='Max Capacity:'}</span><br><span class="capa_data"> {$room_v['max_adults']|escape:'htmlall':'UTF-8'} {l s='Adults'}, {$room_v['max_children']|escape:'htmlall':'UTF-8'} {if $room_v['children'] > 1}{l s='Children'}{else}{l s='Child'}{/if} ({l s='Max guests'} {$room_v['max_guests']|escape:'htmlall':'UTF-8'})</span></div>
							</div>
