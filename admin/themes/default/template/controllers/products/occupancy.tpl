...
{if isset($product->id)}
	...
	<div id="product-occupancy" class="panel product-tab">
        ...
        <div class="alert alert-info">
            {l s='Below, enter the maximum of adult or children or infants which can be accommodated in a room of this room type. Also, enter maximum number of guests for this room type.'}
        </div>

        <div class="form-group">
			<label class="control-label col-sm-2" for="max_extra_adults">
                <span class="label-tooltip" data-toggle="tooltip"
				title="{l s='Enter maximum number of extra adult can be accommodated in a room of this room type.'}">
                    {l s='Maximum extra adult'}
                </span>
			</label>
			<div class="col-sm-3">
