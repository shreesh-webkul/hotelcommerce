				...
				<div class="form-group">
					<div class="fixed-width-xl room_check_in_div">
						<div class="input-group">
							...
							<input type="text" class="form-control add_room_date_from" name="add_product[date_from]" value="{$data.date_from|date_format:"%d-%m-%Y"}" readonly/>
					...
					<div class="fixed-width-xl room_check_out_div">
						<div class="input-group">
							...
							<input type="text" class="form-control add_room_date_to" name="add_product[date_to]" value="{$data.date_to|date_format:"%d-%m-%Y"}" readonly/>
							<div class="input-group-addon"><i class="icon-calendar"></i></div>
						</div>
					</div>
				</div>
