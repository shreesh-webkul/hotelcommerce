...
<div class="row">
    <div class="col-lg-12">
        <table class="table" id="customer_products_details" {if !$hotel_service_products}style="display:none"{/if}>
            <thead>
                <tr>
            ...
            {if $hotel_service_products}
                {foreach from=$hotel_service_products item=product}
                    ...
                    {/if}
                    <tr class="product-line-row" data-id_product="{$product.id_product}" data-id_order_detail="{$product.id_order_detail}" data-id_room_type_service_product_order_detail="{$product.id_room_type_service_product_order_detail}" data-id_hotel="{$product.id_hotel}">
