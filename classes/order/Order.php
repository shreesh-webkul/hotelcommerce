...
class OrderCore extends ObjectModel
{
    ...
    */
     ...
     * @return bool
     */
    public function addOrderPayment($amount_paid, $payment_method = null, $payment_type = null,  $payment_transaction_id = null, $currency = null, $date = null, $order_invoice = null, $update_payment_detail = true)
    {
