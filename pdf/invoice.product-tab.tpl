			...
			{foreach from=$cart_htl_data key=data_k item=data_v}
				{foreach from=$data_v['date_diff'] key=rm_k item=rm_v}
					...
					<tr class="product {$bgcolor_class}">
						...
						<td class="product center">
							<p class="text-left">
								{if $rm_v['adult'] <= 9}0{$rm_v['adult']}{else}{$rm_v['adult']}{/if} {if $rm_v['adult'] > 1}{l s='Adults' mod='wkroomsearchblock'}{else}{l s='Adult' mod='wkroomsearchblock'}{/if}, {if $rm_v['children'] <= 9}0{$rm_v['children']}{else} {$rm_v['children']}{/if} {if $rm_v['children'] > 1}{l s='Children' mod='wkroomsearchblock'}{else}{l s='Child' mod='wkroomsearchblock'}{/if}<br>{if $rm_v['num_rm'] <= 9}0{/if}{$rm_v['num_rm']} {if $rm_v['num_rm'] > 1}{l s='Rooms'}{else}{l s='Room'}{/if}
							</p>
						</td>
						<td class="product center">
							<p>
