    ...
    public function getModuleSql()
    {
        return array(
            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."htl_room_type` (
                ...
                `max_extra_adults` smallint(6) NOT NULL DEFAULT '2',
                `max_extra_children` smallint(6) NOT NULL DEFAULT '0',
                `max_extra_infants` smallint(6) NOT NULL DEFAULT '0',
                `max_guests` smallint(6) NOT NULL DEFAULT '2',
                `extra_adult_price` smallint(6) NOT NULL DEFAULT '0',
                `extra_child_price` smallint(6) NOT NULL DEFAULT '0',
                `extra_infant_price` smallint(6) NOT NULL DEFAULT '0',
            ...
            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."htl_branch_info` (
                ...
                `infant_max_age` smallint(3) unsigned NOT NULL DEFAULT '5',
