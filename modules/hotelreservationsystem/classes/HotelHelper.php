...
class HotelHelper
{
    ...
    public function saveDummyHotelBranchInfo()
    {
        ...
        $objAddress->state_id = $state_id;
        $objAddress->country_id = $def_cont_id;
        $objAddress->zipcode = self::getRandomZipcodeByForCountry($def_cont_id);
        $objAddress->address = 'Monticello Dr, Montgomery, AL 36117, USA';
