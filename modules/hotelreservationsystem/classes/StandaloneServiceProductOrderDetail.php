...
class StandaloneServiceProductOrderDetail extends ObjectModel
{
    public $id_product;
    ...
    public static $definition = array(
        'table' => 'standalone_service_product_order_detail',
        'primary' => 'id_standalone_service_product_order_detail',
        'fields' => array(
    ...
    {
        $sql = 'SELECT * FROM `'._DB_PREFIX_.'standalone_service_product_order_detail` spo
            WHERE 1 AND spo.`id_order` = '.(int)$idOrder;
