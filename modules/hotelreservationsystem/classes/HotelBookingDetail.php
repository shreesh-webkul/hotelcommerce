...
class HotelBookingDetail extends ObjectModel
{
    ...
    public function getBookingDataParams($params)
    {
        ...
        // "page", "num_results", "get_total_rooms" will be used for pagination
     ...
     * @param [type] $id_room_type        [Id of the product to which the room belongs]
     * @param int    $adult            []
     * @param int    $children         []
    ...
    public function getBookingData($params)
    {
        ...
        if ($date_from && $date_to && $hotel_id) {
             ...
             * @TODO:
             * 9) Filters
             * 10) check all original parameters params: only_stats, only_search_data
             * 18) manage dataForFrontSearch
             */
