	...
	<div class="panel-body">
		...
		<div class="btn-group setting-link-div col-sm-3 col-xs-12">
			<a type="button" href="{$additional_demand_setting_link}" class="setting-link btn btn-default col-sm-10 col-xs-10">
				<span class="col-sm-2 col-xs-2"><i class="icon-cog"></i></span>
				<span class="setting-title col-sm-10 col-xs-10">{l s='Facilities' mod='hotelreservationsystem'}</span>
			</a>
			<a tabindex="0" class="btn btn-default col-sm-2 col-xs-2" role="button" data-toggle="popover" data-trigger="focus" title="{l s='Facilities Settings' mod='hotelreservationsystem'}" data-content="{l s='Here create facilities and their prices for room types.' mod='hotelreservationsystem'}" data-placement="bottom">
				<i class="icon-question-circle"></i>
			</a>
		</div>
