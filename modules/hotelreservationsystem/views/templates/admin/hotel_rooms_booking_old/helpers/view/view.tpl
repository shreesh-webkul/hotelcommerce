							...
							<div class="form-group col-sm-12">
								...
								<div class="col-sm-8">
									<select name="booking_product" class="form-control" id="booking_product">
										<option value="1">{l s='Rooms'}</option>
										<option value="0">{l s='Service Products'}</option>
									</select>
								</div>
							</div>
							<div class="form-group col-sm-12">
...
{strip}
	...
	{addJsDefL name=product_type_cond}{l s='Product type is required' js=1 mod='hotelreservationsystem'}{/addJsDefL}
