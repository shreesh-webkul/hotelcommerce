...
$(document).ready(function() {
        ...
        if ($(this).hasClass('num_children')) {
            ...
            if (totalChilds < $(this).val()) {
                ...
                while ($(this).closest('.occupancy_info_block').find('.guest_child_age').length < $(this).val()) {
                    ...
                    var childAgeSelect = '<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">';
    ...
    $(document).on('click', function(e) {
        if ($('.booking_occupancy_wrapper:visible').length) {
            ...
            if (!($(e.target).closest(".booking_occupancy_wrapper").length || $(e.target).closest(".booking_guest_occupancy").length || $(e.target).closest(".avai_add_cart").length)) {
                let hasErrors = 0;
